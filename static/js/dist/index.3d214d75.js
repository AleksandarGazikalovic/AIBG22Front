...
var _ws = require("./ws"); //  ovo sa serverom komunicira
var _configuration = require("./configuration"); // lokalno 
const queryArgs = (0, _qsDefault.default).parse(window.location.search.substring(1) //vraca ? i query deo URL-a (?gameId=1)
);
...
if (gameId) {
    ...
    const game = new (0, _game.Game)(gameId);
    console.log(game);
    game.init();
    console.log(game);
    //let audioGame = new Audio('../js/music.mp3');
    //audioGame.play();
    new (0, _ws.WebsocketHandler)(`ws://${(0, _configuration.API_ROOT)}/streaming?gameId=${gameId}&password=salamala`, game); // 
    console.log(game);
//let audioGame = new Audio('../js/music.mp3');
//audioGame.play();
...
},{"qs":"kW4GH","./game":"5JiMD","./ws":"leZCY","./configuration":"8dYAi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kW4GH":[function(require,module,exports) {
"use strict";
...
},{"./utils":"chmkc"}],"5JiMD":[function(require,module,exports) {
//Uploadovanje slika iz gif-a:
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Game", ()=>Game);
var _playersPng = require("../gif/Players.png");
var _playersPngDefault = parcelHelpers.interopDefault(_playersPng);
var _mapBasePng = require("../gif/MapBase.png");
var _mapBasePngDefault = parcelHelpers.interopDefault(_mapBasePng);
var _tileBorderPng = require("../gif/TileBorder.png");
var _tileBorderPngDefault = parcelHelpers.interopDefault(_tileBorderPng);
var _tilesPng = require("../gif/Tiles.png");
var _tilesPngDefault = parcelHelpers.interopDefault(_tilesPng);
var _bossPng = require("../gif/Boss.png");
var _bossPngDefault = parcelHelpers.interopDefault(_bossPng);
...
let boss = new Image();
players.src = (0, _playersPngDefault.default);
mapBase.src = (0, _mapBasePngDefault.default);
tileBorder.src = (0, _tileBorderPngDefault.default);
FullTileEntities.src = (0, _tilesPngDefault.default);
boss.src = (0, _bossPngDefault.default);
...
class Draw {
    ...
    drawTileBorder(x, y) {
        this.ctx.drawImage(tileBorder, x, y);
    }
...
class Game {
    ...
    draw() {
        ...
        for(let y = 0; y <= numOfRows; y++){
            for(let x = 0; x < cap; x++)this.drawInstance.drawTile(this.map[y][x]);
            if (cap == 29) sgn = -1;
            cap = cap + sgn;
            if (sgn * cap == -14) break;
        }
        // Crtanje player-a:
        for(let i1 = 0; i1 < 4; i1++)//this.drawInstance.drawPlayer(this.players[i].r,this.players[i].q, i );
        this.drawInstance.drawRotatedPlayer(this.players[i1].r, this.players[i1].q, i1, find_angle(this.players[i1].r, this.players[i1].q, this.players[i1].prevR, this.players[i1].prevQ));
    ...
    async showWinner(winner) {
        ...
        if (winner) text = `${winner.name} won the game!`;
        else {
...
const API_ROOT = "localhost:8081" // ovo je problem, radi kod kuce 
 /*
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WebsocketHandler", ()=>WebsocketHandler);
class WebsocketHandler {
    ...
    onMessage(message) {
        ...
        if (data.winner !== null) this.game.showWinner(data.winner);
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequirebb9c")
